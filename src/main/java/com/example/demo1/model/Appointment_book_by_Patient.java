...
public class Appointment_book_by_Patient {
	...
	public Appointment_book_by_Patient(int id, @NotNull int patient_id, @NotNull int doctor_id, LocalDate booked_date,
			LocalTime booked_time, String disease_category, String disease_description,
